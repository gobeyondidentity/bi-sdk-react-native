 ...
 */
declare type CredentialState = 'Active' | 'Revoked';
declare type Success = 'success';
export { AuthenticateResponse, BindCredentialResponse, Credential, CredentialState, Realm, Identity, Tenant, Theme, Success, };
